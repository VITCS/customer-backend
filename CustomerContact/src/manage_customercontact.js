  ...
  try {
    switch (event.field) {
      case "createCustomerContact":
        response = await createCustomerContact(event.body);
        break;
      case "updateCustomerContact":
        response = await updateCustomerContact(event.body);
        break;
      case "deleteCustomerContact":
        response = await deleteCustomerContact(event.body);
        break;
    }
  } catch (e) {
 ...
 **************************************************************/
createCustomerContact = async (body) => {
  try {
    const id = nanoid();
    body.input["id"] = id;
 ...
 **************************************************************/
updateCustomerContact = async (body) => {
  try {
    console.log(body);
 ...
 **************************************************************/
deleteCustomerContact = async (body) => {
  try {
    console.log(body);
