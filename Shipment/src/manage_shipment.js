...
exports.handler = async function (event, context, callback) {
  ...
  try {
    switch (event.field) {
      case "createShipment":
        response = await createShipment(event.body);
        break;
      case "updateShipment":
        response = await updateShipment(event.body);
        break;
      case "deleteShipment":
        response = await deleteShipment(event.body);
        break;
    }
  } catch (e) {
